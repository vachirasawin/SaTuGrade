...
const [menu, setMenu] = useState(false);
    ...
    return (
        <div className = "flex justify-center items-center gap-4">
            ...
            <div onClick = {handleMenuClick} className = {`fixed top-0 left-0 w-full h-[calc(100vh-6rem)] bg-white border-b border-gray-200 p-4 flex flex-col gap-4 -z-10 transition-all duration-500 ease-in-out ${menu ? "translate-y-24" : "-translate-y-[calc(100vh-6rem)]"}`}>
                <NavbarLink/>
                <NavbarButton/>
            </div>
        </div>
